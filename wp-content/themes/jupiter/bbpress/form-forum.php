		...
		<form id="new-post" name="new-post" method="post" action="">
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<p>
						<label for="bbp_forum_title"><?php printf( __( 'Forum Name (Maximum Length: %d):', 'mk_framework' ), bbp_get_title_max_length() ); ?></label><br />
					...
					<p>
						...
						<?php
							bbp_dropdown( array(
								...
								'show_none' => __( '(No Parent)', 'mk_framework' ),
...
<?php elseif ( bbp_is_forum_closed() ) : ?>
	...
	<div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
		<div class="bbp-template-notice">
			<p><?php printf( __( 'The forum &#8216;%s&#8217; is closed to new content.', 'mk_framework' ), bbp_get_forum_title() ); ?></p>
		</div>
	</div>
